...
const products = [
  {name:"Athletic Fit Suit",type:"Suits",price:"$495",colors:"White · Light Grey · Charcoal · Navy · Black",img:"https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=1400&q=85"},
  {name:"Athletic Fit Trouser",type:"Trousers",price:"$145",colors:"White · Light Grey · Charcoal · Navy · Black",img:"https://images.unsplash.com/photo-1598808503746-f34c53b9323e?auto=format&fit=crop&w=1400&q=85"},
...
export default function HomePage(){
 ...
 return <main>
  ...
  <section className="palette"><p className="eyebrow">PERMANENT PALETTE</p><h2>Five suit colors. Almost everything works together.</h2><div className="swatches">{[["White","#ece9df"],["Light Grey","#b8b8b3"],["Charcoal","#444648"],["Navy","#172033"],["Black","#111"]].map(([n,c])=><div key={n}><i style={{background:c}}/><span>{n}</span></div>)}</div></section>
  ...
  <section className="wardrobe"><div className="wardrobeImage"/><div className="wardrobeCopy"><p className="eyebrow">THE SYSTEM</p><h2>Less choice.<br/>Better combinations.</h2><p>The collection is intentionally narrow: office shirts in white, light blue, grey, navy and black; a few rotating microchecks; five permanent tailoring colors; black and brown leather; and seasonal trainers in one light and one dark neutral.</p><div className="combo"><span>MON</span><b>Navy suit / white shirt / brown Oxford</b><span>WED</span><b>Grey trouser / blue shirt / black Oxford</b><span>FRI</span><b>Navy blazer / microcheck / trainer</b></div></div></section>
